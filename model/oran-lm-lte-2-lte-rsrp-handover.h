...
class OranLmLte2LteRsrpHandover : public OranLm
{
  ...
  public:
    /**
     * Gets the TypeId of the OranLmLte2LteRsrpHandover class.
     *
     * @return The TypeId.
     */
    static TypeId GetTypeId(void);
    /**
     * Constructor of the OranLmLte2LteRsrpHandover class.
     */
    OranLmLte2LteRsrpHandover(void);
    /**
     * Destructor of the OranLmLte2LteRsrpHandover class.
     */
  ...
  private:
     ...
     */
    std::vector<OranLmLte2LteRsrpHandover::UeInfo> GetUeInfos(Ptr<OranDataRepository> data) const;
    /**
     ...
     */
    std::vector<OranLmLte2LteRsrpHandover::EnbInfo> GetEnbInfos(Ptr<OranDataRepository> data) const;
    /**
...
}; // class OranLmLte2LteRsrpHandover
