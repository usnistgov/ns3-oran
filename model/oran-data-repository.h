...
public:
  ...
  virtual std::map <Time, Vector> GetNodePositions (uint64_t e2NodeId, 
      Time fromTime, Time toTime, uint64_t maxEntries = 1) = 0;
  /**
   * Gets the the cell information for a UE.
   *
   * \param e2NodeId The E2 Node ID.
   * 
   * \return A tuple with a boolean indicating if the cell info for the UE was found, the eNB cell ID, and the UE RNTI.
   */
   ...
   * \param e2NodeId The E2 Node ID.
   *
   * \return A tuple with a boolean indicating if the cell info for the eNB was found, and the eNB cell ID.
   */
