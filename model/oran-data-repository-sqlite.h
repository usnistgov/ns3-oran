...
protected:
  ...
  enum CreateStatementType {
    ...
    INDEX_LTE_UE_CELL_CELLID, //!< Index for the table with LTE UE Cell Information based on Cell IDs
    INDEX_LTE_UE_CELL_NODEID, //!< Index for the table with LTE UE Cell Information based on E2 Node IDs
   ...
   */
  virtual void CheckQueryReturnCode (sqlite3_stmt* stmt, int rc, std::string boundParmsStr = "" ) const;
  /**
