...
CustomLmQueryTriggerCallback (Ptr<OranReport> report)
{
  ...
  if (report->GetReporterE2NodeId () == 5
    ...
    { 
      ...
      if ((uint32_t)CalculateDistance (lastLocation, center) == (uint32_t)CalculateDistance (location, center))
...
main (int argc, char *argv[])
{
  ...
  oranHelper->AddQueryTrigger ("Crossover", "ns3::OranQueryTriggerCustom",
      "CustomCallback", CallbackValue (MakeCallback(&CustomLmQueryTriggerCallback)));
