...
latex_documents = [
  ('oran', 'oran-module.tex', u'O-RAN Module', u'National Institute of Standards and Technology (NIST)', 'manual'),
]
...
man_pages = [
    ('index', 'O-RAN Module', u'O-RAN Module',
     [u'National Institute of Standards and Technology (NIST)'], 1)
]
